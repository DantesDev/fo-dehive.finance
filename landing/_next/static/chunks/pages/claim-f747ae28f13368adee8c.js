  ...
  [19],
  {
    ...
    PJKM: function (e, t, c) {
      ...
      c.d(t, "a", function () {
        ...
        (function (e) {
          (e.NUXTokenPool = "NUXTokenPool"),
            (e.NUXTMaxPool = "NUXTMaxPool"),
            (e.preSaleTokenPool = "preSaleTokenPool"),
            (e.purchasedPublicSale = "purchasedPublicSale"),
            (e.preSaleMaxPool = "preSaleMaxPool"),
            (e.publicMaxPool = "publicMaxPool"),
            (e.rateForToken = "rateForToken"),
            (e.getDecimal = "getDecimal"),
            (e.getPurchased = "getPurchased"),
            (e.purchasedPublicQuery = "purchasedPublicQuery"),
            (e.getBalanceOf = "getBalanceOf"),
            (e.maxTokensAmount = "maxTokensAmount"),
            (e.getClaimed = "getClaimed"),
            (e.getClaimable = "getClaimable");
        })(a || (a = {}));
    },
    W8Sr: function (e, t, c) {
      e.exports = {
        ...
        N = function () {
          return Object(i.jsx)("section", {
            ...
            children: Object(i.jsxs)("div", {
              ...
              children: [
                Object(i.jsx)("h4", {
                  children: "DHV TOKEN CLAIM INSTRUCTIONS ",
                }),
                Object(i.jsxs)("ol", {
                  children: [
                    Object(i.jsx)("li", {
                      children:
                        "Press connect MetaMask on the top of the \u2018claim page\u2019 The button will start to display your address as soon as it\u2019s connected.",
                    }),
                    Object(i.jsx)("li", {
                      children:
                    ...
                    Object(i.jsx)("li", {
                      children:
                        "Find the \u2018available for claim\u2019 field in the 'claim form' and consider claiming.",
                    }),
                    Object(i.jsxs)("li", {
                      children: [
                        "Press [Claim DHV] if you want to proceed. 5.Sign the transaction in the MetaMask pop-up window. Wait until the transaction will be confirmed. Please, wait until the system notifies you that it\u2019s done.",
                      ],
                    }),
                  ],
                }),
        ...
        C = function () {
          var e = u.a.useForm(),
            ...
            E = Object(_.useMemo)(
              function () {
                return M && P
                  ? new O.a(M.toString()).minus(new O.a(P.toString()))
                  : new O.a(0);
              },
              [M, P]
            ),
          ...
          return Object(i.jsxs)(i.Fragment, {
            children: [
              Object(i.jsx)(f.a, { title: "Claim DHV" }),
              Object(i.jsx)("div", {
                className: T.a.claim,
                  ...
                  children: Object(i.jsxs)("div", {
                    ...
                    children: [
                      Object(i.jsxs)("div", {
                        ...
                        children: [
                          Object(i.jsx)("h1", { children: "Claim your DHV" }),
                        ],
                      }),
                      Object(i.jsxs)("div", {
                        ...
                        children: [
                              ...
                              Object(i.jsxs)("div", {
                                ...
                                children: [
                                  ...
                                  Object(i.jsxs)("p", {
                                    children: [
                                      o && E
                                        ? Object(p.i)(F.toString()).toFixed(4)
                                        : 0,
                                      " ",
                                      "DHV/week",
                                    ],
                          ...
                          Object(i.jsx)("div", {
                            ...
                            children:
                              "*As soon as you claim, your tokens will be transferred to the connected wallet. Make sure you have added DHV token there",
                          }),
                        ],
                      }),
                      Object(i.jsx)(N, {}),
